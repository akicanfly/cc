...
const DEFAULT_PREFIX = `You are CC, an AI coding agent using an OpenAI-compatible API.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are CC, an AI coding agent running within an agent SDK.`
const AGENT_SDK_PREFIX = `You are an AI coding agent running within an agent SDK.`
