...
- Ask where the skill should be saved. Suggest a default based on context (repo-specific workflows → repo, cross-repo personal workflows → user). Options:
  - **This repo** (\`.agents/skills/<name>/SKILL.md\`, or \`.claude/skills/<name>/SKILL.md\`) — for workflows specific to this project
  - **Personal** (\`~/.agents/skills/<name>/SKILL.md\`, or \`~/.claude/skills/<name>/SKILL.md\`) — follows you across all repos
